...
This is a React-based web application that uses Ollama's Phi-3.5 model to analyze code and provide detailed feedback. The application provides a simple interface where users can input their code and receive analysis results.

## Prerequisites

- Node.js (v14 or higher)
- npm (v6 or higher)
- Ollama installed and running locally with the Phi-3.5 model

## Setup

1. Install Ollama and the Phi-3.5 model:
   ```bash
...
4. Wait for the analysis results to appear below.

## Features

- Modern Material-UI interface
- Real-time code analysis using Phi-3.5
- Error handling and loading states
- Responsive design

## Note

This application requires Ollama to be running locally on port 11434 (default Ollama port). Make sure Ollama is running before using the application.
